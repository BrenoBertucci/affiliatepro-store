...
const Shop: React.FC = () => {
  ...
  useEffect(() => {
    const fetchFilteredProducts = async () => {
      ...
      // Use the debounced values for fetching
      ...
      const data = await ProductService.getFiltered(currentFilters, sortOption);
      setProducts(data);
      setLoading(false);
    };

    fetchFilteredProducts();
    // Re-fetch when debounced values or other filters change
  }, [debouncedSearch, filters.category, debouncedMinPrice, debouncedMaxPrice, sortOption]);

  // Client-side filtering is replaced by server-side filtering
