...
const Shop: React.FC = () => {
  ...
  // Optimization: Debounce search and price input to avoid excessive API calls
  // This allows server-side filtering without overloading the database
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      try {
        // Optimization: Use server-side filtering instead of fetching all products
        // This significantly reduces the payload size and main thread blocking on client
    ...
    fetchProducts();
  }, [debouncedSearch, debouncedMaxPrice, debouncedMinPrice, filters.category, sortOption]);
