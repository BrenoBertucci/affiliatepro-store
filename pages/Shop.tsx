...
const Shop: React.FC = () => {
  ...
  // Debounce search and price to prevent excessive API calls
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      // Construct effective filters for the API call
      ...
      const data = await ProductService.getFiltered(activeFilters, sortOption);
      setProducts(data);
      setLoading(false);
    };
    fetchProducts();
  }, [debouncedSearch, debouncedMinPrice, debouncedMaxPrice, filters.category, sortOption]);
