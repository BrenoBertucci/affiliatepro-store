...
const Shop: React.FC = () => {
  ...
  // Debounce search and price to avoid excessive API calls
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      try {
        // Construct effective filters for the query
        const queryFilters = {
          ...filters,
    ...
    fetchProducts();
  }, [debouncedSearch, filters.category, debouncedMaxPrice, sortOption]);
