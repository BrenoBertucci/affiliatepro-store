...
export const ProductService = {
  ...
  // Optimization: Perform filtering on the server side to avoid fetching all products
  getFiltered: async (filters: FilterState, sortOption: string): Promise<Product[]> => {
    ...
    // Search
    if (filters.search) {
      // sanitize search term to prevent errors
    ...
    // Price
    // Replicating client-side logic: filters.minPrice <= price <= filters.maxPrice
