...
export const ProductService = {
  ...
  // Optimization: Fetch filtered products directly from Supabase to avoid fetching all records
  getFiltered: async (filters: FilterState, sortOption: string): Promise<Product[]> => {
    ...
    // Search
    if (filters.search) {
      // Sanitize search term to prevent syntax errors with commas in the .or() filter
